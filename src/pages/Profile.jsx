...
export default function Profile() {
  ...
  const handleAddAddress = async (e) => {
    e.preventDefault();
    try {
      const res = await apiFetch("/profile/addresses", {
        method: "POST",
        headers: {
  ...
  const setAsDefault = async (index) => {
    try {
      const res = await apiFetch(`/profile/addresses/${index}/default`, {
        method: "PUT",
      });
  ...
  const deleteAddress = async (index) => {
    ...
    try {
      const res = await apiFetch(`/profile/addresses/${index}`, {
        method: "DELETE",
      });
