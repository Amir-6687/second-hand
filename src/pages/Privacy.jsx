            ...
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  At The Grrrls Club, we are committed to protecting your privacy and personal information. 
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-600 space-y-1">
                  <li>With trusted service providers (payment processors, shipping companies)</li>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">7. Your Rights (GDPR)</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
