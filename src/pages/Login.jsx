        ...
        <div className="backdrop-blur-md bg-white/20 rounded-2xl shadow-2xl border border-white/30 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              ...
              <input
                className="w-full border border-white/60 bg-white backdrop-blur-sm text-gray-900 placeholder-gray-700 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-white/60 focus:border-transparent transition-all md:bg-white md:backdrop-blur-0 md:border-white/80"
                type="password"
